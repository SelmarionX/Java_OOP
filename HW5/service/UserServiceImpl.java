...
import HomeWork.HW5.model.BottleOfWater;
import HomeWork.HW5.model.HotDrinks;
import HomeWork.HW5.model.VendingMachineAllProducts;
import HomeWork.HW5.model.base.BaseBottleOfWater;
import HomeWork.HW5.model.base.BaseHotDrinks;
import HomeWork.HW5.view.ConsoleUI;
...
public class UserServiceImpl implements UserService {
    ...
    private void addProduct(ConsoleUI consoleUI){
        ...
        if (ch.equalsIgnoreCase("1")) { // Бутилированный напиток
            ...
            consoleUI.printMessage("Ошибка ввода!");
        }
    }
    ...
    private void printListProduct(ConsoleUI consoleUI){
        ...
        } else consoleUI.printMessage("Ошибка ввода!");
    }
}
